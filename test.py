...
def google_wps_triangulation(bssids, desired_mac):
    ...
    for bssid in bssids:
        access_point = {"macAddress":bssid, "signalStrength":-75, "signalToNoiseRatio":20}
...
def bssid_collection_via_wigle():
    ...
    # Pittsford
    min_lat = 43.09236979150439
    min_long = -77.51533066218884
    ...
    if response.status_code == 200:
        ...
        if response.get("success"):
            ...
            for network in results:
                ...
                #print("BSSID: ", bssid, " SSID: ", ssid, " Coordinates: ", coordinates)
            return bssids
        else:
